...
echo "<a href='../landBrowsePage.php'>عذرا, قم بتسجيل الدخول</a>". "<br>". "<br>". "<br>";
...
//echo "عذرا, لايمكنك رؤية التفاصي
//echo"      ||     ";ل لأنك غير مسجل </a>     ||     ". "<br>";
//echo "<a href='../sign_log/login.html'>تسجيل الدخول </a>". "<br>";
