   ...
   $phpVariable = "$city";
	 ?>
          ...
          <form name="form1" action="searchPrice.php"  method="post">
			<text> <strong>أدخل السعر:  </strong></text>
			<text>مثال: 10000</text>
    		<input type="text"  placeholder="ابحث" name="price" aria-label="Search" required ></input> 
			<input type="hidden" name= "phpVariable" onclick="submitForms()" value="<?php echo htmlspecialchars($phpVariable); ?>" >
    		<input type="submit" placeholder="search" name="submit" onclick="submitForms()"> </input> 
  	</form> 
